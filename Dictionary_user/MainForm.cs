    ...
    public partial class MainForm : Form
    {
        ...
        private void activateSwitchButton() // Kích hoạt switchButton 
        {
            if (ktSwitch == true)
            {
                ...
                coloumn = language;
                hint = "VieMeaning";
                setIconButtonSpeaker_Visible(false);
            }
            else
            {
                ...
                setIconButtonSpeaker_Visible(true);
                coloumn = "VieMeaning";
                hint = language;
            }
            resetSuggestion();
        ...
        private void textboxSearch_OnValueChanged(object sender, EventArgs e) // Khi thay đổi giá trị textboxSearch 
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    labelHint4.Text = "";
                    labelHint3.Text = "";
                }/////adndasndnkjnkjasndkjnsaddasdasd
                if (num > 1)
        ...
        private void setIconButtonSpeaker_Visible(bool speak)
        {
            iconButtonSpeaker1.Visible = speak;
            iconButtonSpeaker2.Visible = speak;
            iconButtonSpeaker3.Visible = speak;
            iconButtonSpeaker4.Visible = speak;
            iconButtonSpeaker5.Visible = speak;
            iconButtonSpeaker6.Visible = speak;
            iconButtonSpeaker7.Visible = speak;
            iconButtonSpeaker8.Visible = speak;
        }
        ...
        #endregion      //Load Random Volcabulary in Database
